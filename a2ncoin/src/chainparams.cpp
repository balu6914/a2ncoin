...
// Copyright (c) 2009-2015 The A2ncoin Core developers
...
{
    const char* pszTimestamp = "The Times 06/Sep/2023 New Coin";
    const CScript genesisOutputScript = CScript() << ParseHex("090684710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1693971192, 2000416162, 0x1e0ffff0, 1, 100 * COIN);
        ...
        vSeeds.push_back(CDNSSeedData("192.168.1.4", "192.168.1.4", true));
        //vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        //vSeeds.push_back(CDNSSeedData("h2hcointools.com", "dnsseed.h2hcointools.com"));
        //vSeeds.push_back(CDNSSeedData("h2hcoinpool.org", "dnsseed.h2hcoinpool.org"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0000000017847ea805d0e74f38fb623affab9c2488acfb85f69b0c98a78190d4"))
        ...
        chainTxData = ChainTxData{
            ...
            1693971192, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1693971192, 1234750, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x1b12f78e12c23567dc44eb49f5c6e8031fb99da1bed696e1f8afaf1a708d124b"));
        assert(genesis.hashMerkleRoot == uint256S("69a47de1c5bea3c49a7707712f665ecd920241a70c0d4f4a22abb215830aba7e"));
        ...
        //vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.a2ncoin.loshan.co.uk", true));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0x1b12f78e12c23567dc44eb49f5c6e8031fb99da1bed696e1f8afaf1a708d124b")),
        };
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1693971192, 0, 0x207fffff, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xbfbb1ccfc3d413e29e807540fd8ddd43aead50dfa09ac9444b4ac1d3a050e845"));
        assert(genesis.hashMerkleRoot == uint256S("69a47de1c5bea3c49a7707712f665ecd920241a70c0d4f4a22abb215830aba7e"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0xbfbb1ccfc3d413e29e807540fd8ddd43aead50dfa09ac9444b4ac1d3a050e845"))
        };
