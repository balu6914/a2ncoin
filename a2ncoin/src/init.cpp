 ...
 * between bitcoind, and a2ncoin-qt and non-server tools.
*/
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/a2ncoin-project/a2ncoin>";
    const std::string URL_WEBSITE = "<https://a2ncoin.org>";
...
/** Sanity checks
 *  Ensure that A2ncoin is running in a usable environment with all
...
static bool LockDataDirectory(bool probeOnly)
{
    ...
    // Make sure only a single A2ncoin process is using the data directory.
