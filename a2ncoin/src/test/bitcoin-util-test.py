...
# Copyright 2016 The A2ncoin Core developers
...
help_text="""Test framework for a2ncoin utils.

Runs automatically during `make check`.

Can also be run manually from the src directory by specifying the source directory:

test/a2ncoin-util-test.py --srcdir='srcdir' [--verbose]
"""
...
if __name__ == '__main__':
    ...
    bctest.bctester(srcdir + "/test/data", "a2ncoin-util-test.json", buildenv)
