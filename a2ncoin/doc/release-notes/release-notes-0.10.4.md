A2ncoin Core version 0.10.4 is now available from:

  <https://a2ncoin.org/bin/a2ncoin-core-0.10.4/>
...
- #6953 `43c2789` Split a2ncoin-tx into its own package
- #6953 `dfe0d4d` Include a2ncoin-tx binary on Debian/Ubuntu
