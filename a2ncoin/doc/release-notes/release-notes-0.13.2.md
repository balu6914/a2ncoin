A2ncoin Core version 0.13.2 is now available from:
  ...
  <https://a2ncoin.org/bin/a2ncoin-core-0.13.2/>
...
- #8908 `4a974b2` Update a2ncoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow a2ncoin-tx to create v2 transactions (btcdrak)
