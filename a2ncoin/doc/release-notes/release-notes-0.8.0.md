A2ncoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/a2ncoin/files/A2ncoin/a2ncoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the A2ncoin
...
New/changed settings (command-line or a2ncoin.conf file)
--------------------------------------------------------
