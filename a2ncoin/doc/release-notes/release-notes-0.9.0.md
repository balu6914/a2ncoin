A2ncoin Core version 0.9.0 is now available from:

  https://a2ncoin.org/bin/0.9.0/
...
earlier versions of A2ncoin, then run the installer (on Windows) or just copy
over /Applications/A2ncoin-Qt (on Mac) or bitcoind/a2ncoin-qt (on Linux).

If you are upgrading from version 0.7.2 or earlier, the first time you run
0.9.0 your blockchain files will be re-indexed, which will take anywhere from 
30 minutes to several hours, depending on the speed of your machine.

On Windows, do not forget to uninstall all earlier versions of the A2ncoin
...
Rebranding to A2ncoin Core
---------------------------

To reduce confusion between A2ncoin-the-network and A2ncoin-the-software we
have renamed the reference client to A2ncoin Core.
...
TX outputs, bloating a2ncoin's UTXO database.
...
Using the standard "./autogen.sh; ./configure; make" to build A2ncoin-Qt and
...
("tell the running a2ncoin daemon to do THIS") was split into a separate
executable, 'a2ncoin-cli'. The RPC client code will eventually be removed from
...
- Rebrand to `A2ncoin Core`
- Move initialization/shutdown to a thread. This prevents "Not responding"
  messages during startup. Also show a window during shutdown.
- Don't regenerate autostart link on every client startup
- Show and store message of normal a2ncoin:URI
- Fix richtext detection hang issue on very old Qt versions
- OS X: Make use of the 10.8+ user notification center to display Growl-like 
  notifications
- OS X: Added NSHighResolutionCapable flag to Info.plist for better font
  rendering on Retina displays.
- OS X: Fix a2ncoin-qt startup crash when clicking dock icon
- Linux: Fix Gnome a2ncoin: URI handler
...
- Add separate a2ncoin-cli client
