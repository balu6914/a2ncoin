A2ncoin Core version 0.9.2.1 is now available from:

  https://a2ncoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 A2N to 0.01 A2N
...
- Fix "Start a2ncoin on system login"
