A2ncoin Core version 0.13.0 is now available from:

  <https://a2ncoin.org/bin/a2ncoin-core-0.13.0/>
...
141](https://github.com/a2ncoin/bips/blob/master/bip-0141.mediawiki), [BIP
143](https://github.com/a2ncoin/bips/blob/master/bip-0143.mediawiki), [BIP
144](https://github.com/a2ncoin/bips/blob/master/bip-0144.mediawiki), and [BIP
145](https://github.com/a2ncoin/bips/blob/master/bip-0145.mediawiki) are
finished and included in this release.  However, BIP 141 does not yet specify
activation parameters on mainnet, and so this release does not support segwit
use on mainnet.  Testnet use is supported, and after BIP 141 is updated with
proposed parameters, a future release of A2ncoin Core is expected that
...
- #7550 `8b958ab` Input-from-stdin mode for a2ncoin-cli (laanwj)
...
- #8153 `75ec320` `fundrawtransaction` feeRate: Use A2N/kB (MarcoFalke)
...
- #7613 `3798e5d` Add autocomplete to a2ncoin-qt's console window (GamerSg)
...
- #7913 `bafd075` Fix for incorrect locking in GetPubKey() (keystorea2ncoin.cpp) (yurizhykin)
...
- #8164 `0f24eaf` [A2ncoin-Tx] fix missing test fixtures, fix 32bit atoi issue (jonasschnelli)
...
- #7975 `fc23fee` Update a2ncoin-core GitHub links (MarcoFalke)
...
- #7850 `229a17c` Removed call to `TryCreateDirectory` from `GetDefaultDataDir` in `src/utila2ncoin.cpp` (alexreg)
