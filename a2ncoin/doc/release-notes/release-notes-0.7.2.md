A2ncoin version 0.7.2 is now available from:
  http://sourceforge.net/projects/a2ncoin/files/A2ncoin/a2ncoin-0.7.2
...
* Fix use-after-free problems in initialization and shutdown, the latter of
  which caused A2ncoin-Qt to crash on Windows when exiting.
