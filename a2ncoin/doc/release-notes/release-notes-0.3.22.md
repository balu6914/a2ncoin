Download URL: https://sourceforge.net/projects/a2ncoin/files/A2ncoin/a2ncoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 A2N fee schedule (users still pay 0.01 A2N per kb, until next version)
