A2ncoin Core version 0.9.4 is now available from:

  https://a2ncoin.org/bin/0.9.4/
...
this update is incompatible with the A2ncoin system and could lead to consensus
forks.

A2ncoin Core released binaries from https://a2ncoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~a2ncoin/+archive/ubuntu/a2ncoin
- A third-party or self-compiled A2ncoin Core

upgrade to A2ncoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
