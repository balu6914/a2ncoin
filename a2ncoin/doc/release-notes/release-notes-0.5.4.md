A2ncoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/a2ncoin/files/A2ncoin/a2ncoin-0.5.4/
...
http://gitorious.org/a2ncoin/bitcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix A2ncoin-Qt notifications under Growl 1.3.
Increase required age of A2ncoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitcoin properly when installing A2ncoin-Qt over it. (Windows)
