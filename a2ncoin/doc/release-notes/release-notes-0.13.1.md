A2ncoin Core version 0.13.1 is now available from:

  <https://a2ncoin.org/bin/a2ncoin-core-0.13.1/>
...
- **Script versioning:** Segwit makes it easy for future soft forks to allow
  ...
  currently being researched by A2ncoin Core contributors that may use this
...
- #8829 `2a8bca4` Add a2ncoin-tx JSON tests (jnewbery)
- #8834 `1dd1783` blockstore: Switch to dumb dbm (MarcoFalke)
- #8835 `d87227d` nulldummy.py: Don't run unused code (MarcoFalke)
- #8836 `eb18cc1` a2ncoin-util-test.py should fail if the output file is empty (jnewbery)
...
- #8512 `156e305` Corrected JSON typo on setban of neta2ncoin.cpp (sevastos)
- #8683 `8a7d7ff` Fix incorrect file name a2ncoin.qrc  (bitcoinsSG)
...
- #8817 `bcf3806` update a2ncoin-tx to output witness data (jnewbery)
