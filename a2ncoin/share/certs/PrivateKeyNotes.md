...
unlocked to sign the A2ncoin-Qt.app bundle.
...
allowing somebody to distribute a A2ncoin-Qt.app or a2ncoin-qt-setup.exe with a valid
...
that the a2ncoin-qt.exe file inside the installer had not been tampered with.
