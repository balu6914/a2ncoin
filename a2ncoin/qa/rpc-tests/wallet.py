...
class WalletTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        # Send 21 A2N from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 A2N with subtract fee from amount
        ...
        # Sendmany 10 A2N with subtract fee from amount
        ...
        maintenance = [
            ...
            '-zapwallettxes=1',
            '-zapwallettxes=2',
            # disabled until issue is fixed: https://github.com/a2ncoin/a2ncoin/issues/7463
            # '-salvagewallet',
        ]
        chainlimit = 6
